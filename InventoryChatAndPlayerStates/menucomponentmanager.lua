...
local function set_active_components_actual(self, components, ...)
...
Hooks:AddHook("MenuComponentManagerPreSetActiveComponents", "InventoryChatAndPlayerStates_MenuComponentManager_set_active_components", set_active_components_actual)
