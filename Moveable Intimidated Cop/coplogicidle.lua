...
function CopLogicIdle._upd_enemy_detection(data)
	local delay = mic_original_coplogicidle_updenemydetection(data)
	return data.unit:base().mic_is_being_moved and math.min(delay, CopLogicIdle.mic_check_surroundings(data)) or delay
end
