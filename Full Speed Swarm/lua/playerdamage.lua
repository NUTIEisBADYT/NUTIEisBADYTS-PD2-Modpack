...
function PlayerDamage:init(...)
	self._current_max_health = managers.player.fs_current_max_health * managers.crime_spree:modify_value('PlayerDamage:GetMaxHealth', 1)
...
function PlayerDamage:_check_update_max_health()
	...
	local max_health = max_health_no_cs * managers.crime_spree:modify_value('PlayerDamage:GetMaxHealth', 1)
...
PlayerDamage._max_armor = PlayerDamage._total_armor
